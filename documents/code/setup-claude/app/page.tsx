export default function Home() {
  ...
  const steps = [
    { step: "01", label: "Install", detail: "npx setup-claude" },
    { step: "02", label: "Choose a template", detail: "Next.js · Python · Rust · Blank" },
    { step: "03", label: "Start building", detail: "Claude is ready. Open your editor." },
  ];
  ...
  return (
    <div className="min-h-screen bg-white text-zinc-900 font-sans">
      ...
      <nav className="border-b border-zinc-100 px-6 py-4 flex items-center justify-between max-w-5xl mx-auto">
        <span className="font-semibold text-lg tracking-tight">setup-claude</span>
        <a
      ...
      <section className="max-w-5xl mx-auto px-6 pt-24 pb-20 text-center">
        <span className="inline-block text-xs font-medium tracking-widest uppercase text-orange-500 mb-4">
          Claude Code · Setup Tool
        </span>
        <h1 className="text-5xl font-bold tracking-tight leading-tight mb-6">
          The fastest way to set up{" "}
          <span className="text-orange-500">Claude Code</span>
        </h1>
        ...
        <div className="flex items-center justify-center gap-4 flex-wrap">
          <div className="bg-zinc-900 text-white rounded-lg px-5 py-3 font-mono text-sm">
            npx setup-claude
          </div>
          <a
            href="https://docs.anthropic.com/en/docs/claude-code/overview"
            target="_blank"
            rel="noopener noreferrer"
            className="border border-zinc-200 rounded-lg px-5 py-3 text-sm font-medium hover:border-zinc-400 transition-colors"
          >
            Read the docs
          </a>
        </div>
      ...
      <section className="max-w-5xl mx-auto px-6 py-20">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
          {features.map(({ icon, title, description }) => (
            <div
              key={title}
              className="border border-zinc-100 rounded-xl p-6 hover:border-zinc-300 transition-colors"
            >
      ...
      <section className="bg-zinc-900 text-white py-20">
        <div className="max-w-5xl mx-auto px-6 text-center">
          ...
          <div className="bg-zinc-800 inline-block rounded-lg px-6 py-3 font-mono text-sm text-orange-400">
            npx setup-claude
          </div>
        </div>
      </section>
